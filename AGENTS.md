...
InSpec compliance profile implementing the **Oracle Linux 8**. Maintained by the MITRE SAF Team. Uses CINC-Auditor (open-source Chef InSpec) to automate security compliance validation against OCI tenancies.

- Profile: `oracle-linux-8-baseline`
- Version: 2.6.0
- License: Apache-2.0
