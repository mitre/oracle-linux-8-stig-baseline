control 'SV-252650' do
  title 'The OL 8 operating system must not have accounts configured with blank or null passwords.'
...
$ sudo passwd -l [username]'
  impact 0.7
  tag check_id: 'C-56106r818744_chk'
  tag severity: 'high'
  tag gid: 'V-252650'
  tag rid: 'SV-252650r991589_rule'
  tag stig_id: 'OL08-00-010121'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56056r818745_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
