...
If the returned line does not have a value of "0", a line is not returned, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure OL 8 to ignore IPv6 ICMP redirect messages.
...
$ sudo sysctl --system'
  impact 0.5
  tag check_id: 'C-52322r1155499_chk'
  tag severity: 'medium'
  tag gid: 'V-248888'
  tag rid: 'SV-248888r1156641_rule'
  tag stig_id: 'OL08-00-040280'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-52276r1155500_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
