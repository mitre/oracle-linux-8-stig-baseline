...
/lib/sysctl.d/*.conf
/etc/sysctl.conf"
  desc 'check', 'Verify OL 8 ignores IPv6 ICMP redirect messages.
...
If conflicting results are returned, this is a finding.'
  desc 'fix', %q(Configure OL 8 to ignore IPv6 ICMP redirect messages with the following command:
...
net.ipv6.conf.all.accept_redirects = 0)
  impact 0.5
  tag check_id: 'C-52322r833275_chk'
  tag severity: 'medium'
  tag gid: 'V-248888'
  tag rid: 'SV-248888r991589_rule'
  tag stig_id: 'OL08-00-040280'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-52276r858678_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
