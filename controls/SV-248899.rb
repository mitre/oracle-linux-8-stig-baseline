control 'SV-248899' do
  title 'OL 8 network interfaces must not be in promiscuous mode.'
...
$ sudo ip link set dev <devicename> multicast off promisc off'
  impact 0.5
  tag check_id: 'C-52333r780261_chk'
  tag severity: 'medium'
  tag gid: 'V-248899'
  tag rid: 'SV-248899r991589_rule'
  tag stig_id: 'OL08-00-040330'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-52287r780262_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
