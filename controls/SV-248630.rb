...
When the kernel invokes "systemd-coredump" to handle a core dump, it runs in privileged mode and will connect to the socket created by the "systemd-coredump.socket" unit. This, in turn, will spawn an nonprivileged "systemd-coredump@.service" instance to process the core dump.'
...
Created symlink /etc/systemd/system/systemd-coredump.socket -> /dev/null'
  ...
  tag gid: 'V-248630'
  tag rid: 'SV-248630r1156670_rule'
