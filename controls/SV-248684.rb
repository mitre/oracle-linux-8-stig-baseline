control 'SV-248684' do
  title 'OL 8 must prevent a user from overriding the session lock-enabled setting for the graphical user interface.'
...
/org/gnome/desktop/screensaver/lock-enabled'
  impact 0.5
  tag check_id: 'C-52118r779616_chk'
  tag severity: 'medium'
  tag gid: 'V-248684'
  tag rid: 'SV-248684r958402_rule'
  tag stig_id: 'OL08-00-020082'
  tag gtitle: 'SRG-OS-000029-GPOS-00010'
  tag fix_id: 'F-52072r779617_fix'
