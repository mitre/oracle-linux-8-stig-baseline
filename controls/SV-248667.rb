control 'SV-248667' do
  title 'OL 8 must configure the use of the pam_faillock.so module in the /etc/pam.d/system-auth file.'
...
account required pam_faillock.so'
  impact 0.5
  tag check_id: 'C-52101r779565_chk'
  tag severity: 'medium'
  tag gid: 'V-248667'
  tag rid: 'SV-248667r958388_rule'
  tag stig_id: 'OL08-00-020025'
  tag gtitle: 'SRG-OS-000021-GPOS-00005'
  tag fix_id: 'F-52055r779566_fix'
