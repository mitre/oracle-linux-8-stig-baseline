control 'SV-248907' do
  title 'OL 8 must prevent nonprivileged users from executing privileged functions, including disabling, circumventing, or altering implemented security safeguards/countermeasures.'
...
If they are not mapped in this way, this is a finding.'
  desc 'fix', 'Configure OL 8 to prevent nonprivileged users from executing privileged functions, including disabling, circumventing, or altering implemented security safeguards/countermeasures.
...
This must be documented with the information system security officer (ISSO) as an operational requirement.'
  impact 0.5
  tag check_id: 'C-52341r928563_chk'
  tag severity: 'medium'
  tag gid: 'V-248907'
  tag rid: 'SV-248907r958726_rule'
