...
/lib/sysctl.d/*.conf
/etc/sysctl.conf'
  desc 'check', 'Verify OL 8 restricts usage of ptrace to descendant processes with the following commands:

$ sysctl kernel.yama.ptrace_scope
kernel.yama.ptrace_scope = 1

If the returned line does not have a value of "1", or a line is not returned, this is a finding.'
  desc 'fix', 'Configure OL 8 to restrict usage of ptrace to descendant processes by adding the following line to "/etc/sysctl.d/99-sysctl.conf":
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-248890'
  tag rid: 'SV-248890r1156646_rule'
  tag stig_id: 'OL08-00-040282'
  tag fix_id: 'F-52278r1156645_fix'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  tag 'host'
