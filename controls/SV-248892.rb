...
/lib/sysctl.d/*.conf
/etc/sysctl.conf'
  desc 'check', 'Note: User namespaces are used primarily for Linux containers. If containers are in use, this requirement is Not Applicable.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-248892'
  tag rid: 'SV-248892r1156650_rule'
  tag stig_id: 'OL08-00-040284'
  tag fix_id: 'F-52280r1156649_fix'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  tag 'host'
