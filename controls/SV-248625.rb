control 'SV-248625' do
  title 'OL 8 file systems must not interpret character or block special devices that are imported via Network File System (NFS).'
...
If a file system found in "/etc/fstab" refers to NFS and it does not have the "nodev" option set, this is a finding.'
  ...
  impact 0.5
  tag check_id: 'C-52059r1155538_chk'
  tag severity: 'medium'
  tag gid: 'V-248625'
  tag rid: 'SV-248625r1156665_rule'
