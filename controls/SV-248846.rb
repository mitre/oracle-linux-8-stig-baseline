...
If results are returned and the "noexec" option is missing, or if "/dev/shm" is mounted without the "noexec" option, this is a finding.'
  desc 'fix', 'Configure OL 8 so that "/dev/shm" is mounted with the "noexec" option by adding/modifying "/etc/fstab" with the following line:

tmpfs /dev/shm tmpfs defaults,nodev,nosuid,noexec 0 0'
  impact 0.5
  tag check_id: 'C-52280r780102_chk'
  tag severity: 'medium'
  tag gid: 'V-248846'
  tag rid: 'SV-248846r958804_rule'
  tag stig_id: 'OL08-00-040122'
  tag gtitle: 'SRG-OS-000368-GPOS-00154'
  tag fix_id: 'F-52234r780103_fix'
  tag 'documentable'
  tag cci: ['CCI-001764']
  tag nist: ['CM-7 (2)']
end
