...
If conflicting results are returned, this is a finding.'
  desc 'fix', 'Configure the system to restrict exposed kernel pointer addresses access by adding the following line to a file in the "/etc/sysctl.d" directory:
...
$ sudo sysctl --system'
  impact 0.5
  tag check_id: 'C-52325r833281_chk'
  tag severity: 'medium'
  tag gid: 'V-248891'
  tag rid: 'SV-248891r991589_rule'
  tag stig_id: 'OL08-00-040283'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-52279r858684_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
