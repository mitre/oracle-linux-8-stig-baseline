...
/lib/sysctl.d/*.conf
/etc/sysctl.conf)
  desc 'check', 'Verify OL 8 is configured to enable DAC on symlinks.
...
If "fs.protected_symlinks " is not set to "1" or is missing, this is a finding.'
  desc 'fix', 'Configure OL 8 to enable DAC on symlinks with the following:
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-248577'
  tag rid: 'SV-248577r1156620_rule'
  tag stig_id: 'OL08-00-010373'
  tag fix_id: 'F-51965r1155440_fix'
  tag cci: ['CCI-002165']
  tag nist: ['AC-3 (4)']
  tag 'host'
