...
If the "accept_ra" value is not "0" and is not documented with the information system security officer (ISSO) as an operational requirement, this is a finding.'
  desc 'fix', 'Configure OL 8 to not accept router advertisements on all IPv6 interfaces by default unless the system is a router.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-248885'
  tag rid: 'SV-248885r1156638_rule'
  tag stig_id: 'OL08-00-040262'
  tag fix_id: 'F-52273r1155491_fix'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  tag 'host'
