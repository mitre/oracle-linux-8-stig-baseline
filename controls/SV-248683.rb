control 'SV-248683' do
  title 'OL 8 must prevent a user from overriding the session idle-delay setting for the graphical user interface.'
...
/org/gnome/desktop/screensaver/idle-delay'
  impact 0.5
  tag check_id: 'C-52117r779613_chk'
  tag severity: 'medium'
  tag gid: 'V-248683'
  tag rid: 'SV-248683r958402_rule'
  tag stig_id: 'OL08-00-020081'
  tag gtitle: 'SRG-OS-000029-GPOS-00010'
  tag fix_id: 'F-52071r779614_fix'
