control 'SV-252659' do
  title 'OL 8 systems below version 8.4 must ensure the password complexity module in the password-auth file is configured for three retries or less.'
...
Add the following line to the "/etc/pam.d/password-auth" file (or modify the line to have the required value):
     ...
     password requisite pam_pwquality.so retry=3'
  impact 0.5
  tag check_id: 'C-56115r902816_chk'
  tag severity: 'medium'
  tag gid: 'V-252659'
  tag rid: 'SV-252659r991589_rule'
  tag stig_id: 'OL08-00-020103'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56065r902817_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
end
