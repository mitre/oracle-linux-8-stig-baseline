...
If there is no evidence that the transfer of the audit logs being offloaded to another system or media is encrypted, this is a finding.)
  desc 'fix', 'Configure the operating system to authenticate the remote logging server for off-loading audit logs by setting the following option in "/etc/rsyslog.conf" or "/etc/rsyslog.d/[customfile].conf":

$ActionSendStreamDriverAuthMode x509/name'
  impact 0.5
  tag check_id: 'C-52251r1069155_chk'
  tag severity: 'medium'
  tag gid: 'V-248817'
  tag rid: 'SV-248817r1069157_rule'
  tag stig_id: 'OL08-00-030720'
  tag gtitle: 'SRG-OS-000342-GPOS-00133'
  tag fix_id: 'F-52205r1069156_fix'
