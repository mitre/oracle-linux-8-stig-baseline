...
If the grub superusers account password does not begin with "grub.pbkdf2.sha512", this is a finding.'
  desc 'fix', 'Configure the system to require an encrypted grub bootloader password for the grub superusers account with the grub2-setpassword command, which creates/overwrites the "/boot/efi/EFI/redhat/user.cfg" file. 
...
Confirm password:'
  impact 0.7
  tag check_id: 'C-51971r779175_chk'
  tag severity: 'high'
  tag gid: 'V-248537'
