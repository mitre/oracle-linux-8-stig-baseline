control 'SV-248580' do
  title 'OL 8 must prevent kernel profiling by nonprivileged users.'
...
/lib/sysctl.d/*.conf
/etc/sysctl.conf'
  desc 'check', 'Verify OL 8 is configured to prevent kernel profiling by nonprivileged users with the following commands:
...
If "kernel.perf_event_paranoid" is not set to "2" or is missing, this is a finding.'
  desc 'fix', 'Configure OL 8 to prevent kernel profiling by nonprivileged users.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-248580'
  tag rid: 'SV-248580r1156623_rule'
  tag stig_id: 'OL08-00-010376'
  tag fix_id: 'F-51968r1155449_fix'
  tag cci: ['CCI-001090']
  tag nist: ['SC-4']
  tag 'host'
