...
If the "accept_ra" value is not "0" and is not documented with the information system security officer (ISSO) as an operational requirement, this is a finding.'
  desc 'fix', 'Configure OL 8 to not accept router advertisements on all IPv6 interfaces unless the system is a router.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-248884'
  tag rid: 'SV-248884r1156637_rule'
  tag stig_id: 'OL08-00-040261'
  tag fix_id: 'F-52272r1155488_fix'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  tag 'host'
