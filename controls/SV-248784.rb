...
'
  desc 'check', %q(Verify OL 8 generates an audit record for any use of the "truncate", "ftruncate", "creat", "open", "openat", and "open_by_handle_at" system calls by running the following command to check the file system rules in "/etc/audit/audit.rules":
...
$ sudo service auditd restart'
  ...
  tag severity: 'medium'
  tag gid: 'V-248784'
  tag rid: 'SV-248784r958412_rule'
  tag stig_id: 'OL08-00-030420'
  tag gtitle: 'SRG-OS-000037-GPOS-00015'
  tag fix_id: 'F-52172r818677_fix'
  tag satisfies: ['SRG-OS-000037-GPOS-00015', 'SRG-OS-000042-GPOS-00020', 'SRG-OS-000062-GPOS-00031', 'SRG-OS-000064-GPOS-00033', 'SRG-OS-000392-GPOS-00172', 'SRG-OS-000462-GPOS-00206', 'SRG-OS-000471-GPOS-00215']
  tag 'documentable'
