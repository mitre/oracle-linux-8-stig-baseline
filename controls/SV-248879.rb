...
/lib/sysctl.d/*.conf
/etc/sysctl.conf'
  desc 'check', 'Verify OL 8 will not accept IPv4 source-routed packets.
...
If the returned line does not have a value of "0", a line is not returned, or the line is commented out, this is a finding.'
  desc 'fix', 'Configure OL 8 to ignore IPv4 source-routed packets.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-248879'
  tag rid: 'SV-248879r1156631_rule'
  tag stig_id: 'OL08-00-040239'
  tag fix_id: 'F-52267r1155470_fix'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  tag 'host'
