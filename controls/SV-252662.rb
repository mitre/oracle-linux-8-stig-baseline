control 'SV-252662' do
  title 'OL 8 must not enable IPv4 packet forwarding unless the system is a router.'
...
/lib/sysctl.d/*.conf
/etc/sysctl.conf'
  desc 'check', 'Verify OL 8 is not performing IPv4 packet forwarding, unless the system is a router.
...
If the IPv4 forwarding value is not "0" and is not documented with the information system security officer (ISSO) as an operational requirement, this is a finding.'
  desc 'fix', 'Configure OL 8 to not allow IPv4 packet forwarding unless the system is a router.
...
$ sudo sysctl --system'
  impact 0.5
  tag check_id: 'C-56118r1155481_chk'
  tag severity: 'medium'
  tag gid: 'V-252662'
  tag rid: 'SV-252662r1156635_rule'
  tag stig_id: 'OL08-00-040259'
  tag gtitle: 'SRG-OS-000480-GPOS-00227'
  tag fix_id: 'F-56068r1155482_fix'
  tag 'documentable'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  tag 'host'
