...
/lib/sysctl.d/*.conf
/etc/sysctl.conf)
  desc 'check', 'Verify OL 8 does not IPv4 ICMP redirect messages.
...
If "net.ipv4.conf.all.send_redirects" is not set to "0" and is not documented with the information system security officer (ISSO) as an operational requirement or is missing, this is a finding.'
  desc 'fix', 'Configure OL 8 to not allow interfaces to perform IPv4 ICMP redirects.
...
$ sudo sysctl --system'
  ...
  tag gid: 'V-248877'
  tag rid: 'SV-248877r1156629_rule'
  tag stig_id: 'OL08-00-040220'
  tag fix_id: 'F-52265r1155464_fix'
  tag cci: ['CCI-000366']
  tag nist: ['CM-6 b']
  tag 'host'
