control 'SV-252653' do
  title 'OL 8 library directories must be group-owned by root or a system account.'
...
If any system wide shared library directory is returned and is not group-owned by a required system account, this is a finding.)
  ...
  tag severity: 'medium'
  tag gid: 'V-252653'
  tag rid: 'SV-252653r991560_rule'
  tag stig_id: 'OL08-00-010351'
  tag gtitle: 'SRG-OS-000259-GPOS-00100'
  tag fix_id: 'F-56059r818754_fix'
  tag 'documentable'
  tag cci: ['CCI-001499']
  tag nist: ['CM-5 (6)']
  tag 'host'
